  ...
  switch(opcode) {
    case 0x00:
      switch(funct) {
        ...
        case 0x08: cout << "jr " << regNames[rs]; break;                                            // copy the 0x03 change to an 8
        case 0x10: cout << "mfhi " << regNames[rd]; break;                                          //copy this paste change to make the format last
        case 0x12: cout << "mflo " << regNames[rd]; break;                                          //opcode is 2 look at green sheet so its jump
        case 0x18: cout << "mult " << regNames[rs] << ", " << regNames[rt]; break;                  //for jump
    ...
    case 0x04: cout << "beq " << regNames[rs] << ", " << regNames[rt]<< ", " << hex <<((pc+4) + simm * 4); break;              // branch address
